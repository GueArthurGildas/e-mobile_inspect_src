...
class Inspection {
  ...
  final dynamic navire;       // encodé en TEXT dans SQLite
  final dynamic navire_json;  // idem
  ...
  factory Inspection.fromJson(Map<String, dynamic> json) {
    try {
      return Inspection(
        ...
        navire: json['navire'] is Map ? Map<String, dynamic>.from(json['navire']) : null,
        navire_json: json['navire_json'] is Map ? Map<String, dynamic>.from(json['navire_json']) : null,
      );
    } catch (e, s) {
      print("❌ Erreur fromJson(Inspection): $e\n$s");
      rethrow; // relance pour debug si besoin
    }
  }
  ...
  Map<String, dynamic> toJson() {
    try {
      return {
        ...
        'navire': navire,
        'navire_json': navire_json,
      };
    } catch (e, s) {
      print("❌ Erreur toJson(Inspection): $e\n$s");
      return {};
    }
  }
  ...
  factory Inspection.fromMap(Map<String, dynamic> map) {
    try {
      return Inspection(
        ...
        navire: map['navire'] != null
            ? (map['navire'] is String
            ? jsonDecode(map['navire'])
            : Map<String, dynamic>.from(map['navire']))
            : null,
        navire_json: map['navire_json'] != null
            ? (map['navire_json'] is String
            ? jsonDecode(map['navire_json'])
            : Map<String, dynamic>.from(map['navire_json']))
            : null,
      );
    } catch (e, s) {
      print("❌ Erreur fromMap(Inspection): $e\n$s");
      rethrow;
    }
  }
  ...
  Map<String, dynamic> toMap() {
    try {
      return {
        ...
        'sync': sync,
        'json_field': jsonField,
        'navire': navire != null ? jsonEncode(navire) : null,
        'navire_json': navire_json != null ? jsonEncode(navire_json) : null,
      };
    } catch (e, s) {
      print("❌ Erreur toMap(Inspection): $e\n$s");
      return {};
    }
  }

  /// -------- Helpers de confort --------
  String? get navireName {
    try {
      if (navire is Map && (navire as Map).containsKey('nom')) {
        return (navire as Map)['nom']?.toString();
      }
      if (navire_json is Map && (navire_json as Map).containsKey('name')) {
        return (navire_json as Map)['name']?.toString();
      }
      if (navire is String) return navire as String;
    } catch (e) {
      print("⚠️ Erreur lecture navireName: $e");
    }
    return null;
  }

  String? get navireIrcs {
    try {
      if (navire is Map && (navire as Map).containsKey('ircs')) {
        return (navire as Map)['ircs']?.toString();
      }
      if (navire_json is Map && (navire_json as Map).containsKey('ircs')) {
        return (navire_json as Map)['ircs']?.toString();
      }
    } catch (e) {
      print("⚠️ Erreur lecture navireIrcs: $e");
    }
    return null;
  }

  String? get navireImo {
    try {
      if (navire is Map) {
        final m = navire as Map;
        final v = m['omi'] ?? m['imo'];
        if (v != null) return v.toString();
      }
      if (navire_json is Map) {
        final m = navire_json as Map;
        final v = m['uvi_imo'] ?? m['imo'];
        if (v != null) return v.toString();
      }
    } catch (e) {
      print("⚠️ Erreur lecture navireImo: $e");
    }
    return null;
  }
}
