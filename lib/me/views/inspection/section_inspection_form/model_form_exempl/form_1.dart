...
class FormInfosGeneralesScreen extends StatefulWidget {
  const FormInfosGeneralesScreen({super.key});

  @override
  State<FormInfosGeneralesScreen> createState() => _FormInfosGeneralesScreenState();
}

class _FormInfosGeneralesScreenState extends State<FormInfosGeneralesScreen> {
        ...
        child: ListView(
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: "Titre de l'inspection"),
            ...
            DropdownButtonFormField<String>(
              value: inspecteur,
              decoration: const InputDecoration(labelText: "Inspecteur assigné"),
              items: ['Inspecteur KONE', 'Inspecteur N’Guessan', 'Inspecteur Traoré']
                  .map((e) => DropdownMenuItem(value: e, child: Text(e)))
                  .toList(),
