      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: const Row(
              children: [
                SizedBox(width: 100, height: 40, child: Text('Left Side')),
                SizedBox(width: 100, height: 40, child: Text('Middle Side')),
                SizedBox(width: 100, height: 40, child: Text('Right Side')),
              ],
            ),
          ),
        ],
