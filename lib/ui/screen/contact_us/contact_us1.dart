        ...
        children: [
          Container(
            ...
            child: Column(
              children: [
                Text(
                  'You can contact us for suggestions, testimonials by filling in the form below :',
                  style: TextStyle(fontSize: 14, color: _color2),
                ),
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelText: 'NAME',
                    labelStyle: TextStyle(fontSize: 12, color: _color3),
                  ),
                ),
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          'CALL CENTER',
                          style: TextStyle(color: _color3, fontSize: 14),
                        ),
