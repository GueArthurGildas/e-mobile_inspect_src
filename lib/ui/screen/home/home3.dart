...
class _Home3PageState extends State<Home3Page> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _categoryData.add(
      CategoryModel(
        id: 1,
        name: 'Fashion',
        image: '$globalUrl/category/fashion.png',
      ),
    );
    _categoryData.add(
      CategoryModel(
    ...
    _categoryData.add(
      CategoryModel(
        id: 4,
        name: 'Otomotif',
        image: '$globalUrl/category/otomotif.png',
      ),
    );
    _categoryData.add(
      CategoryModel(
        id: 5,
        name: 'Sport',
        image: '$globalUrl/category/sport.png',
      ),
    );
    _categoryData.add(
      CategoryModel(id: 6, name: 'Food', image: '$globalUrl/category/food.png'),
    );
    _categoryData.add(
      CategoryModel(
        id: 7,
    ...
    _categoryData.add(
      CategoryModel(id: 9, name: 'Food', image: '$globalUrl/category/food.png'),
    );
    _categoryData.add(
      CategoryModel(
        id: 10,
  ...
  void setupAnimateAppbar() {
    ...
    _topColorAnimationController = AnimationController(
      vsync: this,
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${_trendingData[index].sale} product',
