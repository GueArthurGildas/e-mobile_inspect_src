...
import 'package:e_Inspection_APP/config/apps/food_delivery/constant.dart';
...
class GlobalStyle {
  ...
  static const TextStyle textPromo = TextStyle(fontSize: 12, color: black77);

  static const TextStyle textTag = TextStyle(fontSize: 13, color: softGrey);
  ...
  static const TextStyle ophValue = TextStyle(fontSize: 13, color: black77);
}
